...
3. Entrar al directorio de Apache para modificar el archivo de configuracion `C:\Program Files (x86)\Apache Software Foundation\Apache2.2\conf\httpd.conf`

4. Cambiar la ubicación de la carpeta de donde tomara los archivos
...
5. Cambiar la ubicación de la carpeta donde tomara los archivos
...
6. Define el archivo indice del servidor
...
7. Evito el acceso al archivo de configuracion `.htaccess`
...
8. Por seguridad evitamos mostrar detalles del servidor como la version
