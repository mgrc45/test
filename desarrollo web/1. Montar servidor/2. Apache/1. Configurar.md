...
| Options:Includes | Permite el uso de Server-side includes, del módulo mod_include. (Traduccion: Te permite agregar variables que seran remplazados por valores del servidor, como tiempo, Url, Last Modified...) |
