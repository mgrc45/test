...
Tras instalar el sevidor de apache 2.4.x podemos instalar el interprete de PHP el cual ya fue compilado para windows y dependiendo de la version necesitaremos un componente de Visual Studio.
